...
namespace Fiap.Green.Startup.Controllers
{
    public class TipoProdutoController : Controller
    {
        ...
        public TipoProdutoController(OracleContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdTipoProduto,NomeTipoProduto")] TipoProduto tipoProduto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdTipoProduto,NomeTipoProduto")] TipoProduto tipoProduto)
        {
